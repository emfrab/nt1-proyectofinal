...
namespace ProyectoHotelNT1.Controllers
{
    public class RegistroesController : Controller
    {
        ...
        public RegistroesController(PoseidonDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Dni,NumHabitacion,FechaIngreso,FechaEgreso,DiasHospedado,IdActivo")] Registro registro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Dni,NumHabitacion,FechaIngreso,FechaEgreso,DiasHospedado,IdActivo")] Registro registro)
        {
            if (id != registro.Id)
            {
                return NotFound();
